          ...
          <img src={img1} width={"100%"}/>
             ...
             <hr/>
              ...
              Якщо використовувати стандартні назви методів оплати з таблиці - форматування працюватиме вірно.<br/>
                  ...
                  <li>Наложка р/р = "Післяплата",</li>
                  <li>Контроль оплаты = "Післяплата",</li>
                  <li>На карту = "Безготівка",</li>
                  <li>картка = "Безготівка",</li>
                  <li>Карточка = "Безготівка"</li>
                  <li>на карту банка: "Безготівка"</li>
                  <li>контр: "Післяплата"</li>
